...
GOODProjects requests $18,000 to deepen GOODSports, the sports and life-skills intervention track within GOODLearningHub, serving Black youth ages 5 to 14 in Southwest DC's Ward 6 public housing communities. GOODSports uses football, basketball, and dance as vehicles for teamwork, discipline, goal-setting, conflict resolution, and emotional regulation, directly matching Events DC's Community Grant Program's focus on youth sports organizations in the District.

### Target Population

Residents of James Creek, Syphax Gardens, and Greenleaf public housing communities in Southwest DC's Ward 6.

| Total Unduplicated Participants | 150 in summer (GOODCamp) plus 50 to 100 in afterschool (year-round) |
|---|---|
| Age Range | 5 to 14 |
| Primary Demographic | Black / African American (100% of GOODSports participants) |
| Income Level | 100% below the federal poverty line |
| Geographic Area | Ward 6, Southwest DC (King Greenleaf Recreation Center and DCHA Family Enhancement Center) |

### Activities and Deliverables

| Deliverable | Timeline |
|---|---|
| Daily football, basketball, and dance sessions for 150 youth (GOODCamp) | 8 weeks, summer 2026 |
| Weekly football, basketball, and dance sessions for 50 to 100 youth (afterschool) | 30+ weeks, school year |
| Weekly 20-minute Life Skills Huddle (conflict resolution, goal-setting, emotional regulation, leadership) | Concurrent with all sessions |
| Trauma-informed sports facilitation training for coaches and Youth Services Advocates | Start of program year |
| Final Report | 30 days post-program-year |
...
| Marquel Webb | FSP Lead |
| Phileke Holland | Afterschool Lead / Youth Program Coordinator |
| Cole Bradshaw | Finance & Operations |
| Melissa | Reporting & Stewardship |

GOODSports is staffed by a Director of Youth Development, a Youth Program Coordinator, six Youth Services Advocates, four seasonal coaches, and four High-Impact Tutors, all already in place.

### Evaluation and Performance Metrics

GOODProjects tracks participation and outcomes using Salesforce CRM, staff observation, and quarterly participant assessments.

| Performance Measure | Target |
|---|---|
| Reading proficiency improvement (1+ grade level) | 85% of 150 participants |
| Math proficiency improvement (1+ grade level) | 90% of participants |
| Attendance rate | 95% |
| Teamwork and self-regulation improvement (staff observation) | 80% of participants |
| Conflict resolution (self-reported ability to resolve disagreements calmly) | 75% of participants |
| Peer leadership (participants who become junior coaches or peer leaders) | 20 participants |
| Reporting Frequency | Quarterly, per Events DC's specific reporting schedule once confirmed |

## BUDGET DETAIL

GOODProjects applies a 10% indirect rate to Modified Total Direct Costs unless Events DC specifies otherwise; confirm with Cole before submission.
...
VERIFY BEFORE SUBMITTING: confirm whether Events DC wants exact dollar figures for the in-kind match rows or a narrower calculation; the ranges above come directly from the GOODSports program budget on file and should be tightened to specific numbers with Cole before submission.
